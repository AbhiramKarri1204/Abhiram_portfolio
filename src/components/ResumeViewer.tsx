      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm select-none">
          ...
          <motion.div
            ...
            className="relative w-full max-w-4xl h-[90vh] bg-white rounded-xl shadow-2xl flex flex-col overflow-hidden z-10 border border-gray-200"
          >
            ...
            <div className="flex items-center justify-between px-6 py-4 bg-gray-50 border-b border-gray-200 no-print">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <h3 className="font-sans font-bold text-gray-900 text-sm">Curriculum Vitae</h3>
                  <p className="text-[10px] text-gray-500 font-mono tracking-tight">KARRI_ABHIRAM_RESUME_2026.PDF</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2">
                <button
                  onClick={handlePrint}
                  type="button"
                  className="flex items-center gap-1.5 px-3 py-1.5 bg-white border border-gray-200 hover:border-red-300 hover:bg-red-50 text-gray-700 hover:text-red-600 rounded-lg font-mono text-[10px] uppercase tracking-wider transition-all cursor-pointer min-h-[38px]"
                ...
                <button
                  onClick={onClose}
                  type="button"
                  className="p-2 bg-gray-100 hover:bg-red-50 hover:text-red-600 text-gray-400 rounded-lg transition-all cursor-pointer min-w-[38px] min-h-[38px] flex items-center justify-center"
                >
                  <X className="w-4 h-4" />
                </button>
              </div>
            ...
            <div className="flex-1 overflow-y-auto bg-gray-100 p-4 sm:p-8 flex justify-center no-print">
              
              {/* Actual Printable Page Simulation */}
              <div 
                ref={resumeRef}
                className="w-full max-w-[210mm] bg-white shadow-lg p-6 sm:p-10 text-gray-900 border border-gray-300 rounded-md print-canvas select-text"
              ...
              >
                ...
                <div className="text-center pb-5 border-b-2 border-red-600">
                  <h1 className="text-lg sm:text-xl font-black tracking-tight leading-none mb-2 mt-1">
                    <span className="font-color-white-override bg-red-600 text-white px-3.5 py-1.5 rounded-lg inline-block shadow-md uppercase">
                      Karri Pavan Durga Satya Abhiram
                    </span>
                  </h1>
                  <p className="text-[10px] sm:text-[11px] font-bold text-red-600 tracking-wider uppercase mb-3">
                    Aspiring Generative AI & Enterprise AI Engineer | Python Developer
                  </p>
                  
                  {/* Contact Grid */}
                  <div className="flex flex-wrap justify-center items-center gap-x-4 gap-y-1.5 text-[10px] sm:text-[10.5px] text-gray-600">
                    <span className="flex items-center gap-1">
                      <MapPin className="w-3.5 h-3.5 text-red-600" />
                      Kakinada, Andhra Pradesh, India
                    </span>
                    <span className="text-gray-300">•</span>
                    <a href="mailto:karriabhiram91@gmail.com" className="flex items-center gap-1 hover:text-red-600 transition-colors">
                      <Mail className="w-3.5 h-3.5 text-red-600" />
                      karriabhiram91@gmail.com
                    </a>
                    <span className="text-gray-300">•</span>
                    <a href={PERSONAL_INFO.linkedin} target="_blank" rel="noreferrer" className="flex items-center gap-1 hover:text-red-600 transition-colors">
                      <Linkedin className="w-3.5 h-3.5 text-red-600" />
                      LinkedIn
                    </a>
                    <span className="text-gray-300">•</span>
                    <a href={PERSONAL_INFO.github} target="_blank" rel="noreferrer" className="flex items-center gap-1 hover:text-red-600 transition-colors">
                ...
                <div className="mt-5">
                  <h2 className="text-xs font-bold uppercase tracking-wider text-red-600 border-b border-gray-200 pb-1 mb-2">
                    Professional Summary
                  </h2>
                  <p className="text-[10.5px] sm:text-[11px] text-gray-700 leading-relaxed text-justify">
                ...
                {/* Technical Skills */}
                <div className="mt-5">
                  <h2 className="text-xs font-bold uppercase tracking-wider text-red-600 border-b border-gray-200 pb-1 mb-2.5">
                    Technical Skills
                  </h2>
                  <div className="space-y-1.5 text-[10.5px] sm:text-[11px]">
                    <div>
                      <strong className="text-gray-900">Programming:</strong> <span className="text-gray-700">Python, C, C++</span>
                    </div>
                    <div>
                      <strong className="text-gray-900">Enterprise AI & Generative AI:</strong>{' '}
                    ...
                    <div>
                      <strong className="text-gray-900">Backend & Web:</strong>{' '}
                      <span className="text-gray-700">Flask, REST APIs, API Integration, HTML5, CSS3, JavaScript, Bootstrap, Django (Basics)</span>
                    </div>
                    <div>
                      <strong className="text-gray-900">Data, Tools & Concepts:</strong>{' '}
                      <span className="text-gray-700">Git, GitHub, Jupyter Notebook, VS Code, Matplotlib, OOP, DBMS, Data Structures, Software Engineering</span>
                    </div>
                    <div>
                      <strong className="text-gray-900">Learning Focus:</strong>{' '}
                      <span className="text-gray-700">Enterprise AI architecture, responsible AI, LLM evaluation, workflow automation, cloud AI deployment</span>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      <div className="flex justify-between items-baseline mb-1">
                        <h3 className="text-[11.5px] font-bold text-gray-900 uppercase">
                    ...
                    <div>
                      <div className="flex justify-between items-baseline mb-1">
                        ...
                        <span className="text-[10px] text-gray-500 font-mono">Feb-Apr 2024</span>
                      </div>
                      <div className="text-[10px] text-red-600 font-semibold mb-1">
                    ...
                    <div>
                      <div className="flex justify-between items-baseline mb-1">
                        ...
                        <span className="text-[10px] text-gray-500 font-mono">Feb-Apr 2025</span>
                      </div>
                      <div className="text-[10px] text-red-600 font-semibold mb-1">
                  ...
                  <div className="space-y-3.5">
                    <div>
                      <div className="flex justify-between items-baseline">
                        <strong className="text-[11px] text-gray-900">B.Tech in Computer Science Engineering (Artificial Intelligence)</strong>
                        <span className="text-[10px] text-gray-500 font-mono">2023-2027</span>
                      </div>
                      <div className="text-[10.5px] text-gray-600 flex justify-between items-center">
                        <span className="font-color-red-override bg-white border border-red-600 text-red-600 px-2 py-0.5 rounded-md shadow-sm inline-block font-bold mt-1">
                          Kakinada Institute of Engineering and Technology
                        </span>
                        <span className="font-semibold text-gray-800">CGPA: 7.48/10</span>
                      </div>
                    </div>

                    <div>
                      <div className="flex justify-between items-baseline">
                        <strong className="text-[11px] text-gray-900">Board of Intermediate (MPC)</strong>
                        <span className="text-[10px] text-gray-500 font-mono">2021-2023</span>
                      </div>
                      <div className="text-[10.5px] text-gray-600 flex justify-between items-center">
                        <span className="font-color-red-override bg-white border border-red-600 text-red-600 px-2 py-0.5 rounded-md shadow-sm inline-block font-bold mt-1">
                          Narayana Junior College, Visakhapatnam
                        </span>
                        <span className="font-semibold text-gray-800">89.3%</span>
                      </div>
                    </div>

                    <div>
                      <div className="flex justify-between items-baseline">
                        <strong className="text-[11px] text-gray-900">Board of Secondary Education (10th)</strong>
                        <span className="text-[10px] text-gray-500 font-mono">2020-2021</span>
                      </div>
                      <div className="text-[10.5px] text-gray-600 flex justify-between items-center">
                        <span className="font-color-red-override bg-white border border-red-600 text-red-600 px-2 py-0.5 rounded-md shadow-sm inline-block font-bold mt-1">
                ...
                <div className="mt-5">
                  ...
                  <ul className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-1.5 text-[10.5px] text-gray-700 pl-4 list-disc">
