      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-16 space-y-24 sm:space-y-32">
        ...
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12">
            ...
            <div className="lg:col-span-6 space-y-6">
              <h3 className="inline-flex items-center gap-2 text-base font-bold font-mono tracking-wider uppercase bg-white text-red-600 px-3 py-1.5 rounded-md shadow-md">
